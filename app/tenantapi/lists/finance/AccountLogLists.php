...
class AccountLogLists extends BaseAdminDataLists implements ListsSearchInterface
{
    ...
    public function queryWhere()
    {
        ...
        if (!empty($this->params['user_info'])) {
            $where[] = ['u.real_name|u.nickname|u.mobile|u.account', 'like', '%' . $this->params['user_info'] . '%'];
        }
    ...
    {
        $field = 'u.real_name,u.nickname,u.account,u.mobile,al.action,al.change_amount,al.left_amount,al.change_type,al.source_sn,al.create_time';
